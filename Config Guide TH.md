...
detection_level = 1      # ระดับในการตรวจจับศัตรู ปรับได้ 1 ถึง 5 บางแมพเช่น Dorado จะมีเศษกระดาษบนพื้นสีม่วงๆ บางทีบอทจะสับสนแล้วไปยิงพวกกระดาษนั้น 
...
mouse_mode = 1           # มี 2 โหมด 1 กับ 2 
                         ...
                         # โหมด 2 ใช้ได้เฉพาะ windows 10 และ ใช้กับเกม Valorant ได้ (ศัตรูสีม่วง)
