...
mouse_mode = 1           # มี 2 โหมด 1 กับ 2 
                         # โหมด 1 ใช้ได้กับ windows 10 และ 11 แต่ใช้สำหรับเกม Valorant ไม่ได้
                         # โหมด 2 ใช้ได้เฉพาะ windows 10 และ ใช้กับเกม Valorant ได้ (borderless windowed / ศัตรูสีม่วง)
