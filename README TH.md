...
Aimbot สามารถตั้งค่าได้ 4 โปรไฟล์ ใช้สำหรับตั้งค่าพวกตัวละคร Tracer/76/Dva/Zarya/Bastion และอื่นๆ 

กดปุ่ม Insert เพื่อเปิดโปรมองทะลุ ใช้ได้เฉพาะจอเกม Borderless windowed บางทีมโปรมองจะแสดงผลขึ้นกรอบฝั่งตัวเอง ให้กดปุ่ม PageUP บนคีย์บอร์ดเพื่อเปลี่ยนเป็นแสดงผลฝั่งศัตรู
